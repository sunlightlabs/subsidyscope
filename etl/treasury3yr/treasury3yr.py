...
import OpenAnything
from bailout.models import TreasuryThreeYearBondQuote


class TreasuryThreeYearExtractor(SubsidyExtractor.SubsidyExtractor):
    
    URL = 'http://research.stlouisfed.org/fred2/data/DGS3.txt'
        ...
        for retrieved_file in self._retrieved_files.values():
            for line in open(retrieved_file,'r'):
                ...
                if m:
                    ...
                    bond_quote, bond_quote_was_created = TreasuryThreeYearBondQuote.objects.get_or_create(date=date, defaults={'price': price, 'datarun': self._datarun})                                        
