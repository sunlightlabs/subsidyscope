...
public class ShpTools
{
	 ...
	 * @see ShpRecord 
	 */	
	public static function readHeader(src: FileStream): Object 
	{
		var headerObject:Object = new Object();
		
		src.endian = Endian.BIG_ENDIAN;
		
		headerObject.fileCode = src.readInt();
		...
		headerObject.fileLegth = src.readInt();
		
		src.endian = Endian.LITTLE_ENDIAN;
		
		headerObject.version = src.readInt();
		headerObject.shapeType = src.readInt();
		
		headerObject.xMin = src.readDouble();
		headerObject.yMin = src.readDouble();
		
		headerObject.xMax = src.readDouble();
		headerObject.yMax = src.readDouble();
		
		headerObject.zMin = src.readDouble();
		headerObject.zMax = src.readDouble();
		
		headerObject.mMin = src.readDouble();
		headerObject.mMax = src.readDouble();
		
		return headerObject;
	}
	 
	public static function readRecords(src: FileStream): Array {
	...
	*/
	public static function drawPolyShpFile(src: FileStream, dest: Graphics, zoom: Number=1): ShpHeader {
