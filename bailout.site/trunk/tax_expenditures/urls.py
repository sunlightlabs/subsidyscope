...
urlpatterns = patterns('tax_expenditures.views',
    ...
    url(r'^db/group/(?P<group_id>.*)/(?P<estimate>[1-3])/$', 'group', name="tax_expenditures-group"),
    url(r'^db/group_alt/(?P<group_id>.*)/(?P<estimate>[1-3])/$', 'group_alt', name="tax_expenditures-group_alt"),
    url(r'^db/(?P<estimate>[1-3])/$', 'main', name="tax_expenditures-main"),
