...
primary_energy_consumption = Pie(475, 310, [[('Petroleum', 37), ('Non-Fossil', 17), ('Coal', 22), ('Natural Gas', 24)]], 'piechart_orange.css', y_padding=30, x_padding=120, padding=0)
primary_energy_consumption.output("../media/images/charts/energy/US_primary_energy_consumption_by_major_fuel_type_2008.svg")

energy_related_CO2 = Pie(475, 310, [[('Petroleum', 42), ('Coal', 37), ('Natural Gas', 21)]], 'piechart.css', y_padding=30, x_padding=100, padding=0)
energy_related_CO2.output("../media/images/charts/energy/US_energy_related_CO2_emissions_by_major_fuel_type_2009.svg")

electric_power = Pie(650, 400, [[('Petroleum', 1.1), ('Coal', 48.2), ('Other', 0.6), ('Natural Gas', 21.4), ('Other Renewables', 3.1), ('Nuclear', 19.6), ('Hydroelectric', 6.0)]], 'piechart.css', y_padding=5, x_padding=120)
electric_power.output('../media/images/charts/energy/US_electric_power_industry_net_generation_2008.svg')

energy_tax_expenditures = Pie(650, 400, [[('Coal and refined Coal', 2660), ('Nuclear', 199), ('Natural Gas and \nPetroleum Liquids', 2090), ('Renewables', 670), ('Electricity (not fuel specific)', 735), ('End Use', 120), ('Conservation', 670)]], 'piechart.css', y_padding=30, x_padding=145)
...
primary_energy_consumption = Pie(600, 450, [[('Petroleum', 37), ('Coal', 23), ('Natural Gas', 24), ('Nuclear', 9), ('Renewable', 7)]], 'piechart_orange.css', y_padding=5, x_padding=60)
primary_energy_consumption.output("../media/images/charts/energy/US_primary_energy_consumption_by_source_and_sector_2008.svg")

#little charts
transportation_energy_consumption = Pie(120, 120, [[('Natural Gas', 677), ('Petroleum', 26332), ('Renewables', 833)]], 'piechart_no_label.css', padding=3)
transportation_energy_consumption.output('../media/images/charts/energy/energy_consumption_transportation_2008_SMALL.svg')

industrial_energy_consumption = Pie(120, 120, [[('Natural Gas', 8149), ('Petroleum', 8586), ('Coal', 1840), ('Renewables', 2056)]], 'piechart_no_label.css', padding=3)
industrial_energy_consumption.output('../media/images/charts/energy/energy_consumption_industrial_2008_SMALL.svg')

residential_commerical_energy_consumption = Pie(120, 120, [[('Natural Gas', 8198), ('Petroleum', 1756), ('Coal', 74), ('Renewables', 722)]], 'piechart_no_label.css', padding=3)
...
electric_energy_consumption = Pie(120, 120, [[('Natural Gas', 6823), ('Petroleum', 463), ('Coal', 20547), ('Renewables', 3690), ('Nuclear Electric power', 8455), ('Imports', 112)]], 'piechart_no_label.css', padding=3)
