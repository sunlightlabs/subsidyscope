...
#treasury_jct_comparison = Column(400, 200, [[('Energy', 6440), 
#				    ('Housing', 187640),
#                    ('Transportation', 3690)],
#				    [('Energy', 47140), 
#				    ('Housing', 160920),
#                    ('Transportation', 9480)]], "barchart.css", x_label_padding=10, x_label_height=50)
#
#treasury_jct_comparison. max_x_point_width=30
...
energy_grants = Line(300, 200, [[(1982, 515.8),
								...
								(2007, 1081.1),
								(2008, 1151.9),
								(2009, 1237.7)]], 'linechart.css', label_intervals=5, currency=False, x_padding=10, padding=10, units="")
