...
urlpatterns = patterns('', 
    ...
    url(r'^risk-transfers/test/subtest/$', direct_to_template, {'template': 'nonprofits/risk_transfers.html'}, name='nonprofits-risk-transfers-subtest'),
    url(r'^risk-transfers/test/subtest/furthersubtest/$', direct_to_template, {'template': 'nonprofits/risk_transfers.html'}, name='nonprofits-risk-transfers-subtest'),
