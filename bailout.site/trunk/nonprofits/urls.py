...
urlpatterns = patterns('', 
    ...
    url(r'^overview/structure/', redirect_to, {'url': '/nonprofits/summary/structure/'}, name='nonprofits-overview-structure'),
    url(r'^overview/', redirect_to, {'url': '/nonprofits/summary/'}, name='nonprofits-overview'),
