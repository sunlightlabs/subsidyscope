...
urlpatterns = patterns('', 
    ...
    url(r'^highways/funding/state/overview/', direct_to_template, {'template': 'transportation/highways/funding_state_overview.html', 'extra_context':{'subsector': 3}}, name='transportation-highway-funding-state-text'),
