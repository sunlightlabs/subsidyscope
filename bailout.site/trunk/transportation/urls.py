...
urlpatterns = patterns('', 
    ...
    url(r'^highways/funding/state/by_source/(?P<state_id>[0-9]+)/', 'transportation.views.get_state_highway_funding_by_source', name='transportation-highway-funding-state'),
    url(r'^highways/funding/state/by_govt/(?P<state_id>[0-9]+)/', 'transportation.views.get_state_highway_funding_by_govt', name='transportation-highway-funding-state'),
