...
urlpatterns = patterns('',
    ...
    url(r'^review/(?P<task_id>[0-9]+)/tag/(?P<tag_id>[0-9]+)/$', 'subsidysort.views.review', name='subsidysort-review'),
    url(r'^review/(?P<task_id>[0-9]+)/tag/(?P<tag_id>[0-9]+)/(?P<tag_location>[0-9]+)/$', 'subsidysort.views.review', name='subsidysort-review'),
