...
def carousel_entries(sector_id):
    ...
    for c in entries:
        ...
        out += '<div id="tab-%d" class="carousel-tab" style="height: 400px;"><img src="%s" width="415"><h2><a href="%s">%s</a></h2><p class="feature_content">%s%s</p>' % (i, c.image.url, c.link, c.title, date_string, c.text)
