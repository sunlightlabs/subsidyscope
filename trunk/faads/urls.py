...
urlpatterns = patterns('', 
    ...
    url(r'^direct-expenditures/search/map-csv/', 'faads.views.map_data_csv', {}, name='faads-search-map-csv'),
    ...
    url(r'^direct-expenditures/search/summary/state/', 'faads.views.state_summary_statistics', {}, name='faads-search-summary-state'),
    url(r'^direct-expenditures/search/summary/program/', 'faads.views.program_summary_statistics', {}, name='faads-search-summary-program'),
)