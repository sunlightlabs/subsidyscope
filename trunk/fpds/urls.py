...
urlpatterns = patterns('', 
    ...
    url(r'^contracts/search/map-table/', 'fpds.views.map_data_table', {}, name='fpds-search-map-table'),
    url(r'^contracts/search/map-csv/', 'fpds.views.map_data_csv', {}, name='fpds-search-map-csv'),
