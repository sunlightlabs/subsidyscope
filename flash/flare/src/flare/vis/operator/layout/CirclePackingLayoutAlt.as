package flare.vis.operator.layout
{
	 ...
	 * ACM CHI 2006.</p>
	 */
	public class CirclePackingLayoutAlt extends Layout
	{
		 ...
		 *  Ordered nodes are placed in a spiral starting at the center.
		 */
		public function CirclePackingLayoutAlt(spacing:Number=4,
		...
		private function packCircle(nodes:Array, N:int):Number
		{
			...
			{
				function compare(p1:ChainNode, p2:ChainNode):int 
				{
					if (p1.dist < p2.dist) 
	        			return 1;
				...
				//Contract
				var damping:Number = 0.1 / Number(iteration);
