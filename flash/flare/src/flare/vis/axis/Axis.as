package flare.vis.axis
{
	...
	public class Axis extends Sprite implements IScaleMap
	{
		...
		private var _labelFormater:Function = null;
		...
		public function set labelFormater(func:Function):void {
			_labelFormater = func;
		}
		...
		protected function updateLabel(label:AxisLabel) : void
		{
			...
			if(_labelFormater != null)
			{
				label.text = _labelFormater(label.value);
			}
			else
			{
