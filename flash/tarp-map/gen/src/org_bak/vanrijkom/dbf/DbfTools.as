...
public class DbfTools
{
	 ...
	 * 
	 */	
	public static function readZeroTermANSIString(src: FileStream): String {
		var r: String = "";
		var b: int;
	 ...
	 * 
	 */	
	public static function readANSIString(src: FileStream, length: uint): String {
		var r: String = "";
		while(length--) {
	 ...
	 * 
	 */	
	public static function getRecord(src: FileStream, header: DbfHeader, index: uint): DbfRecord {
